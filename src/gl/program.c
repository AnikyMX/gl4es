...
static void fill_program(program_t *glprogram)
{
    ...
    LOAD_GLES3(glGetProgramiv);
    LOAD_GLES3(glGetActiveUniform);
    LOAD_GLES3(glGetUniformLocation);
    LOAD_GLES3(glGetActiveAttrib);
    LOAD_GLES3(glGetAttribLocation);
    int n=0;
    int maxsize=0;
    khint_t k;
    int ret;
